...
//		StringBuffer sb = new StringBuffer();
	...
	public void verifyCartImage() {
		
		Assert.assertEquals(true, element("cart_img").isDisplayed());
	}
	
	public void verifySignIn() {
		
		Assert.assertEquals(true, element("sign_in").isDisplayed());
	}
	
	public void clickSignIn() {
		
		Assert.assertEquals(true, element("sign_in_btn").isDisplayed());
	}
